...
def get_token_auth_header():
   ...
   try:
        ...
        print(f'AuthError Exception: {auth_error}')
        abort(401, auth_error)
...
def requires_auth(permission=''):
    def requires_auth_decorator(f):
        ...
        def wrapper(*args, **kwargs):
            ...
            #     elif auth_error.status_code == 400:
            #         missing_permission_route(auth_error.error)
